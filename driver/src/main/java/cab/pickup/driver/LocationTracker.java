...
import cab.pickup.driver.server.PostTask;
...
public class LocationTracker extends Service implements LocationListener,
    ...
    public void onLocationChanged(Location location) {
        ...
        PostTask locUpdateTask = new PostTask(null);
        locUpdateTask.addPostData("position", getLatitude()+","+getLongitude());
        locUpdateTask.setUrl(""+context.me.id);

        locUpdateTask.execute();
    }
